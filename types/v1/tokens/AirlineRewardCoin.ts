...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface AirlineRewardCoinInterface extends Interface {
...
decodeFunctionResult(functionFragment: 'transferFrom', data: BytesLike): Result;
  ...
  export interface AirlineRewardCoin extends BaseContract {
    
    connect(runner?: ContractRunner | null): AirlineRewardCoin;
    waitForDeployment(): Promise<this>;

    interface: AirlineRewardCoinInterface;
